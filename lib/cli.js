...
(function() {
  ...
  commander.version('0.2.4').usage('[options] [dir]').option('-a, --address <string>', 'set hostname [localhost]').option('-f, --format <string>', 'connect logger format [dev]', 'dev').option('-p, --port <number>', 'set port number [3000]', 3000);
